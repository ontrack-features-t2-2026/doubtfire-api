...
class AuthTest < ActiveSupport::TestCase
  ...
  def test_auth_post
    ...
    user_keys = %w[id email first_name last_name username nickname display_name receive_task_notifications receive_portfolio_notifications receive_feedback_notifications display_peer_progress opt_in_to_research has_run_first_time_setup theme_preference]
