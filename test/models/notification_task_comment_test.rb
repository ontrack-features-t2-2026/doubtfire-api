...
class NotificationTaskCommentTest < ActiveSupport::TestCase
  ...
  def test_an_abbreviation_with_a_space_is_encoded_in_the_link
    ...
    assert_equal "/projects/#{@project.id}/dashboard/Portfolio%20Reflection/feedback", notification.link
    assert_valid_push_payload(
      notification,
      expected_link: "/projects/#{@project.id}/dashboard/Portfolio%20Reflection/feedback"
    )
  end
