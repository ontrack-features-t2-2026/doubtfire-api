...
class PushNotificationService
  ...
  # MAX_CLICK_LINK_LENGTH is checked first and would decide anyway. The optional
  # /feedback tail is the one deep link into a task the dashboard opens directly.
